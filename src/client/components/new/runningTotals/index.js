...
class RunningTotals extends Component {
  ...
  render() {
    ...
    if (this.state.existingReceipt.airlineTicket) {
      airlineTicketLabel = <Header.Subheader>{this.state.existingReceipt.airlineTicket.fromCity} -> {this.state.existingReceipt.airlineTicket.toCity}
      &nbsp;({this.state.existingReceipt.airlineTicket.flightClass})</Header.Subheader>;
    ...
    if (this.state.existingReceipt.aircraftCharter) {
      aircraftCharterLabel = <Header.Subheader>{this.state.existingReceipt.aircraftCharter.fromCity} -> {this.state.existingReceipt.aircraftCharter.toCity}
        &nbsp;({this.state.existingReceipt.aircraftCharter.aircraftType})</Header.Subheader>;
